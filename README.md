...
### 8. Тестируемость
- **Слоистая архитектура**: Отдельные слои для API, бизнес-логики и доступа к данным
- **Моки в тестах**: Использование unittest.mock для изоляции тестов
- **Простая настройка**: Docker Compose позволяет легко поднять тестовое окружение
